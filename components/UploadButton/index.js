            ...
            {showModal && (
                <div className="fixed top-0 z-30 w-screen h-screen backdrop-blur-lg bg-black/30 flex">
                    <div className="relative w-[40vw] h-[40vh] bg-[#0f1b32] text-[#96C6FF] m-auto p-5 rounded-2xl font-[Poppins] flex flex-col">
                        ...
                        <p>Flight Name:</p>
                        <input className="bg-[#0f1b32] rounded outline outline-green-300 text-white pl-2 p-2 text-xl"/>
                        <button className="bg-green-300 text-slate-800 font-[Audiowide] w-fit px-10 py-2 text-xl mx-auto mt-auto rounded-full shadow hover:scale-105 transition-all">Upload</button>
                    </div>
                </div>
            )}
        </>
